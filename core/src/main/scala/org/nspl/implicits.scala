...
trait ImplicitConversions {
  ...
  implicit def dsToTuple1[T, F: FC](ds: T)(implicit f: T => DataSource): PlotData =
  ...
  implicit def dsToTuple3d[T, F: FC](ds: ((T, List[DataRenderer]), LegendConfig))(
    implicit
    f: T => DataSource
  ...
  implicit def listConv2[T, F: FC](ds: Seq[(T, List[DataRenderer], LegendConfig)])(
    implicit
    f: T => DataSource
  ): Seq[PlotData] =
